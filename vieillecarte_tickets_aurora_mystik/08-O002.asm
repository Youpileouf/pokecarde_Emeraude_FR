...
DataPointers:
    db $70,$01 ; DataStartEonTicket A9 size
    db $19,$02 ; DataStartAuroraTicket A9 size
    db $C2,$02 ; DataStartMysticTicket A9 size
...
TitleText:
	db "TICKETS CADEAUX\0"



FrontPageText:
	db "Voyagez vers des iles exotiques!\0"

FrontPageTextLine2:
	db "Merci de votre participation!\0"
...
FirstPage:
    db "Sélectionnez le ticket que vous\0"
...
ThirdPageLine3:
    db "Advance contenant Pokémon Emeraude.\0"
...
OldSeaMapText:
	db "VIEILLECARTE \0" ; second text need to start 16 char after the first one (not counting \0)

AuroraTicketText:
	db "   TICKETAURORA \0" ; third text need to start 16 char after the second one (not counting \0)
...
OldSeaMapSprite:
	INCBIN "sprites/old_sea_map.4bpp"
MysticTicketSprite:
...
OldSeaMapPalette:
	INCBIN "sprites/old_sea_map.gbapal"
MysticTicketPalette:
...
Start:
    ...
    CreateCustomSprite RegionHandlePtr2845, $02, OldSeaMapSpriteData
...
sub_273C: ; MenuSelectText
	DrawText RegionHandlePtr2844, OldSeaMapText2, 0, 4
