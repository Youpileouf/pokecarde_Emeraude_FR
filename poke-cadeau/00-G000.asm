...
TicketSprite: ; 104
	INCBIN "GiftPokemon.4bpp"
TicketPalette: ; 1604
	INCLUDE "GiftPokemon.pal"

Prologue:
	INCBIN "prologue-{REGION_NAME}.bin"

DataPacket: ; 164a
	INCBIN "giftpokemon-{REGION_NAME}.mev"
	db 0,0,0 ; padding
...
Instructions2: ; 199d
	...
	db "Emeraude pour recevoir un\n"
	db "Pokémon spécial.\0"

DeliveryInProcess: ; 1a0d
	db "Livraison du Pokémon en cours...\0"
